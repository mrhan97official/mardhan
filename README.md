...
Banner **Aplikasi unggulan** dapat diatur langsung pada halaman Projects melalui tombol **Atur banner**: pilih aplikasi dari daftar, isi judul dan deskripsi, lalu unggah JPG/PNG/WebP. Pengguna juga dapat mengganti atau menghapus banner. Gambar sumber hingga 30 MB diolah di browser dengan batas 1920 × 720 piksel dan rasio tetap. Hasil dikompres menjadi JPEG kualitas 82%; bila JPG/PNG asal sudah lebih ringan dan tidak perlu dikecilkan, aplikasi memakai berkas asal. Pratinjau menunjukkan ukuran sebelum dan sesudah. Gambar hasil dikirim langsung ke R2 privat, sedangkan pilihan aplikasi dan teks disimpan di D1, sehingga banner yang tersimpan muncul pada perangkat lain setelah pemeriksaan data berikutnya. Untuk memakai unggahan, konfigurasi R2 S3/CORS yang sama seperti thumbnail di bawah tetap diperlukan. Pengolahan banner ini tidak mengubah unggahan thumbnail kartu.
