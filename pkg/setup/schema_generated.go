...
var expectedColumns = map[string][]string{
  ...
  "cloudflare_zone_approval": {"id", "zone_id", "zone_name", "project_id", "vercel_synced", "approved_at"},
  "traffic_monitoring": {"id", "mode", "updated_at"},
  "api_traffic_hourly": {"bucket", "requests", "response_bytes"},
  ...
  "app_promo_banner": {"id", "target_repo", "title", "description", "image_repo", "version", "updated_at"},
...
var expectedTypes = map[string]map[string]string{
  ...
  "cloudflare_zone_approval": {"id": "INTEGER", "zone_id": "TEXT", "zone_name": "TEXT", "project_id": "TEXT", "vercel_synced": "INTEGER", "approved_at": "TEXT"},
  "traffic_monitoring": {"id": "INTEGER", "mode": "TEXT", "updated_at": "TEXT"},
  "api_traffic_hourly": {"bucket": "TEXT", "requests": "INTEGER", "response_bytes": "INTEGER"},
  ...
  "app_promo_banner": {"id": "INTEGER", "target_repo": "TEXT", "title": "TEXT", "description": "TEXT", "image_repo": "TEXT", "version": "TEXT", "updated_at": "TEXT"},
